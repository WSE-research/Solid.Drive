...
* *URLs and history:* the open folder is reflected in the query string (`folder=…`); copy the address bar to share a deep link, and use the browser back/forward buttons to move through your navigation history
