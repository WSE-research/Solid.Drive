...
:docker-image: wseresearch/solid-hello-world-frontend-react
:toc:
:toclevels: 3
:toc-placement!:
...
See link:src/README.adoc[src/README.adoc] for the full layer map and dependency rules. +
See link:src/.shapes/README.adoc[src/.shapes/README.adoc] for shape definitions. +
