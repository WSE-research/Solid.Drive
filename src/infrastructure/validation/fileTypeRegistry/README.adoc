...
* link:../tboxParser/[tboxParser] parses the raw TBox Turtle document to extract the type definitions loaded by this registry.
* link:../../../features/file-explorer/hooks/useFileTypes/[useFileTypes] is the React hook that wraps this registry and exposes its types to components.
