...
Type guard functions for narrowing LDO resource types.
LDO exposes resource capabilities through method presence (duck typing) rather than a class hierarchy.
These guards make it safe to call those methods.
