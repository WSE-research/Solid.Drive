 ...
 * for example by `app/` or by `auth/Header`, MUST be re-exported here.
 * Direct imports into the feature's internal sub-paths from outside the
 * feature are considered a private-API leak and should be replaced with
