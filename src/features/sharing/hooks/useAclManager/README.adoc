...
* link:../../../../infrastructure/wac/aclManager/[aclManager] provides the low-level ACL discovery and write functions that this hook orchestrates.
* link:../../../../infrastructure/solid/sharedCatalog/[sharedCatalog] provides the URI helpers and catalog write operations called during every grant and revoke.
* link:../../../file-explorer/components/SharePanel/[SharePanel] is the component that calls this hook and renders the current grantee list.
